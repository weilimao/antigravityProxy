/**
 * Antigravity Proxy - Settings Controller
 * Handles System Logs Toggle switch, Startup settings, and About Tab display logic
 */
...
(function () {
    ...
    function init() {
        ...
        try {
            const chkEnableSystemLog = document.getElementById('chkEnableSystemLog');
            const systemConsole = document.getElementById('systemConsole');
            const chkEnableAutoStart = document.getElementById('chkEnableAutoStart');
            const chkEnableSilentStart = document.getElementById('chkEnableSilentStart');
            ...
            if (btnAboutRepo) {
                btnAboutRepo.addEventListener('click', (e) => {
                    e.preventDefault();
                    shell.openExternal('https://github.com/weilimao/antigravityProxy');
                });
            }
            ...
            if (btnAboutChangelog) {
                btnAboutChangelog.addEventListener('click', (e) => {
                    e.preventDefault();
                    shell.openExternal('https://github.com/weilimao/antigravityProxy/releases');
                });
            }
            ...
            if (btnAboutFeedback) {
                btnAboutFeedback.addEventListener('click', (e) => {
                    e.preventDefault();
                    shell.openExternal('https://github.com/weilimao/antigravityProxy/issues');
                });
            }
            ...
            if (chkEnableSystemLog) {
                ...
                // Toggle listener
                chkEnableSystemLog.addEventListener('change', (e) => {
            ...
            if (chkEnableAutoStart) {
                chkEnableAutoStart.addEventListener('change', (e) => {
                    const enabled = e.target.checked;
                    try {
            ...
            if (chkEnableSilentStart) {
                chkEnableSilentStart.addEventListener('change', (e) => {
                    const enabled = e.target.checked;
                    try {
            ...
            function updateConsoleVisibility(enabled) {
                if (systemConsole) {
                    if (enabled) {
